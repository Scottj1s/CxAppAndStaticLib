...
template<> inline ::Platform::Object^ ActivateType<::CxComponent::StaticLibrary2::Control2>()
{
    return reinterpret_cast<Platform::Object^>(make_CxComponent_StaticLibrary2_Control2());
}
